...
> ถ้าแก้ `data.js` ด้วยมือ ให้รัน `python3 gen_data.py` ไม่ได้ ให้แก้เลข `?v=` ใน
> `<script src="data.js?v=...">` ของ `index.html` เป็นอะไรก็ได้ที่ไม่ซ้ำเดิมแทน
> ไม่งั้นคนที่เคยเข้าเว็บแล้วจะยังเห็นข้อมูลเก่าไปอีก 10 นาที (GitHub Pages ตั้ง
